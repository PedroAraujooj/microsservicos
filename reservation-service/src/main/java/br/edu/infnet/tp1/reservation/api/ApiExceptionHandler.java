...
import br.edu.infnet.tp1.reservation.service.CapacityExceededException;
import br.edu.infnet.tp1.reservation.service.EventNotFoundException;
import br.edu.infnet.tp1.reservation.service.ReservationNotFoundException;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ProblemResponse> handleNotFound(RuntimeException exception) {
        return problem(HttpStatus.NOT_FOUND, exception.getMessage());
    }

    @ExceptionHandler(CapacityExceededException.class)
    public ResponseEntity<ProblemResponse> handleCapacity(CapacityExceededException exception) {
